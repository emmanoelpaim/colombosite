        ...
        <Toolbar sx={{ justifyContent: 'space-between', py: 0.5 }}>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
            ...
            {isMobile ? (
              ...
              <>
                <Button color="inherit" component="a" href={`${import.meta.env.BASE_URL}linktree`}>
                  Link Tree
                </Button>
                <Button color="inherit" component="a" href={`${import.meta.env.BASE_URL}lgpd`}>
                  LGPD
                </Button>
                {navItems.map((item) => (
      ...
      <Drawer anchor="right" open={drawerOpen} onClose={() => setDrawerOpen(false)}>
        <List sx={{ width: 260, pt: 2 }}>
          <ListItem disablePadding>
            <ListItemButton component="a" href={`${import.meta.env.BASE_URL}linktree`} onClick={() => setDrawerOpen(false)}>
              <ListItemText primary="Link Tree" />
            </ListItemButton>
          </ListItem>
          <ListItem disablePadding>
            <ListItemButton component="a" href={`${import.meta.env.BASE_URL}lgpd`} onClick={() => setDrawerOpen(false)}>
